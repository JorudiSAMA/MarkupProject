...
function start() {
  // Agafem l'element on anirá la data
  var el = document.getElementById("data");

  // Interval per actualitzar la data
  var dateInterval = setInterval(setDate, 1000);

  // Funció per cambiar la cata
  function setDate() {
    var date = new Date();
  ...
  alerta("cos","alert1","You are on Home Page. Click on the X for closing this window","red")
